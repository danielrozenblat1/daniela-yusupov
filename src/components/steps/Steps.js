...
const Timeline = () => {
  ...
  const steps = [
    {
      number: 1,
      title: "שיחת ייעוץ",
      content: "אנחנו מבינות לאיזה סוג תסרוקות ואיפור את מתחברת יותר מתאמות ציפיות וכמובן אני נותנת את הדעה המקצועית שלי לפי תווי פנים/ שיער/לבוש.",
      icon: MessageCircle
    },
    {
      number: 2,
      title: "חודש לפני החתונה (לכלות)",
      content: "איפור ושיער נסיון - אנחנו נפגשות בסטודיו שלי / שיחת ווידאו ומייצרות לך את הנראות שאת הולכת לקבל, שתוכלי להגיע לחתונה עם האיפור והשיער שחלמת עליהן וכמובן - מתאמות ציפיות  עד שמתאימות את הנראות המושלמת שתצאי סגורה 100%",
      icon:Calendar
    },
    {
      number: 3,
  ...
  return <>
    ...
    <Button text="דניאלה בואי נשריין תאריך"/>
  </>
};
