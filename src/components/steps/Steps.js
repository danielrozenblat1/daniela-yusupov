...
const Timeline = () => {
  ...
  const steps = [
    ...
    },
    {
      number: 4,
      title: "יום האירוע",
      content: "אני מגיעה, לשמח אותך להקליל את היום ומתחילה בעבודה - מסרקת אותך, עוברות לאיפור וטאצאפים. כמובן שאנחנו נפגשות גם בערב לטאצאפים לפני/אחרי החופה",
      icon: Sparkles
    }
  ];
