...
import logo from "../../images/דניאל יוסופוב לוגו.png"
...
const NavBarNew = () => {
  ...
  const handleClick = () => {
    const phoneNumber = "";
    const message = "היי דניאלה ,אני רוצה לשמוע ממך עוד על..";
      ...
      {(isMenuOpen || isClosing) && windowWidth <= 850 && (
        <div className={`${styles.mobileMenu} ${isClosing ? styles.closing : ''}`}>
          <div className={styles.mobileMenuContent}>
            ...
            <img className={styles.image} src={logo} alt="דניאלה יוסופוב לוגו"/>
            </div>
          </div>
        </div>
      )}
