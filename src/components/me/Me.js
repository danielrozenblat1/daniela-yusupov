...
import daniela from "../../images/דניאלה יוסופוב תדמית.jpg"
    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            מתחילת דרכי האמנתי שכל כלה ראויה להרגיש מושלמת ביום החשוב בחייה, ללא קשר למצב הכלכלי. לכן, בניתי חבילות במחירים נגישים לכל כיס, המשלבות איפור ועיצוב שיער ברמה הגבוהה ביותר, תוך התאמה מדויקת לסוג העור והשיער שלך, וליווי אישי לאורך כל הדרך.
          </p>
          
          <p className={styles.description}>
            אני מאמינה שיום החתונה הוא הרבה מעבר למראה מושלם - זו חוויה שלמה. אני כאן בשבילך 24/7, להקשיב, להרגיע, ולהפוך את ההכנות לחלק מהזיכרונות המתוקים של היום המיוחד שלך. כי בסופו של יום, הביטחון והשמחה שלך הם המראה הכי יפה שאפשר לייצר.
          </p>
        </div>
      </div>
      <Recommends/>
